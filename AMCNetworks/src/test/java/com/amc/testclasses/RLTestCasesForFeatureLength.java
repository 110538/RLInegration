...
public class RLTestCasesForFeatureLength extends AMCBaseClass {
	...
	public RLTestCasesForFeatureLength() {
	...
	public void validateAMCNIDForFeatureLength() throws Exception {
		LoginModule login = new LoginModule(driver);
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForFeatureLength");
	...
	public void validateAssetTitleForFeatureLength() throws Exception {
		LoginModule login = new LoginModule(driver);
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForFeatureLength");
	...
	public void validateAssetShowTypeForFeatureLength() throws Exception {
		LoginModule login = new LoginModule(driver);
	...
	public void validateAssetSourceForFeatureLength() throws Exception {
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForFeatureLength");
	...
	public void validateProductionModeForFeatureLength() throws Exception {
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForFeatureLength");
		String assetSourceString = dataBook[testCaseNo][5];
		if (!assetSourceString.contains("Acquired")) {
	...
	public void validateOriginForFeatureLength() throws Exception {
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForFeatureLength");
		String assetSourceString = dataBook[testCaseNo][5];
	...
	public void validateOwnerNetworkForFeatureLength() throws Exception {
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForFeatureLength");
	...
	public void validateCastTypeForFeatureLength() throws Exception {
		readTestCaseNo("validateCastTypeForFeatureLength");
	...
	public void validateFirstNameOfCastMemberForFeatureLength() throws Exception {
		int testCaseNo = readTestCaseNo("validateFirstNameOfCastMemberForFeatureLength");
	...
	public void validateAlternativeTitleForAKAForFeatureLength() throws Exception {
		int testCaseNo = readTestCaseNo("validateAlternativeTitleForAKAForFeatureLength");
	...
	public void validateAlternativeTitleTypeForAKAForFeatureLength() throws Exception {
		readTestCaseNo("validateAlternativeTitleTypeForAKAForFeatureLength");
	...
	public void validateAlternativeTitleForLegalForFeatureLength() throws Exception {
		int testCaseNo = readTestCaseNo("validateAlternativeTitleForLegalForFeatureLength");
	...
	public void validateAlternativeTitleTypeForLegalTypeForFeatureLength() throws Exception {
		readTestCaseNo("validateAlternativeTitleTypeForLegalTypeForFeatureLength");
	...
	public void validateTitleTypeForFeatureLength() throws Exception {
		readTestCaseNo("validateTitleTypeForFeatureLength");
	...
	public void validateReleaseYearForFeatureLength() throws Exception {
		int testCaseNo = readTestCaseNo("validateReleaseYearForFeatureLength");
	...
	public void validateTRTForFeatureLength() throws Exception {
		int testCaseNo = readTestCaseNo("validateTRTForFeatureLength");
	...
	public void validateProductionCompanyForFeatureLength() throws Exception {
		int testCaseNo = readTestCaseNo("validateProductionCompanyForFeatureLength");
