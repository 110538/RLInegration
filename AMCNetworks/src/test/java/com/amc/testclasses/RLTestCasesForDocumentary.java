...
public class RLTestCasesForDocumentary extends AMCBaseClass {
	...
	public RLTestCasesForDocumentary() {
	...
	public void validateAMCNIDForDocumentary() throws Exception {
		LoginModule login = new LoginModule(driver);
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForDocumentary");
	...
	public void validateAssetTitleForDocumentary() throws Exception {
		LoginModule login = new LoginModule(driver);
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForDocumentary");
	...
	public void validateAssetShowTypeForDocumentary() throws Exception {
		LoginModule login = new LoginModule(driver);
	...
	public void validateAssetSourceForDocumentary() throws Exception {
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForDocumentary");
	...
	public void validateProductionModeForDocumentary() throws Exception {
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForDocumentary");
		String assetSourceString = dataBook[testCaseNo][5];
		if (!assetSourceString.contains("Acquired")) {
	...
	public void validateOriginForDocumentary() throws Exception {
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForDocumentary");
		String assetSourceString = dataBook[testCaseNo][5];
	...
	public void validateOwnerNetworkForDocumentary() throws Exception {
		int testCaseNo = readTestCaseNo("createNewRLAssetOfTypeForDocumentary");
	...
	public void validateCastTypeForDocumentary() throws Exception {
		readTestCaseNo("validateCastTypeForDocumentary");
	...
	public void validateFirstNameOfCastMemberForDocumentary() throws Exception {
		int testCaseNo = readTestCaseNo("validateFirstNameOfCastMemberForDocumentary");
	...
	public void validateAlternativeTitleForAKAForDocumentary() throws Exception {
		int testCaseNo = readTestCaseNo("validateAlternativeTitleForAKAForDocumentary");
	...
	public void validateAlternativeTitleTypeForAKAForDocumentary() throws Exception {
		readTestCaseNo("validateAlternativeTitleTypeForAKAForDocumentary");
	...
	public void validateAlternativeTitleForLegalForDocumentary() throws Exception {
		int testCaseNo = readTestCaseNo("validateAlternativeTitleForLegalForDocumentary");
	...
	public void validateAlternativeTitleTypeForLegalTypeForDocumentary() throws Exception {
		readTestCaseNo("validateAlternativeTitleTypeForLegalTypeForDocumentary");
	...
	public void validateTitleTypeForDocumentary() throws Exception {
		readTestCaseNo("validateTitleTypeForDocumentary");
	...
	public void validateReleaseYearForDocumentary() throws Exception {
		int testCaseNo = readTestCaseNo("validateReleaseYearForDocumentary");
	...
	public void validateTRTForDocumentary() throws Exception {
		int testCaseNo =readTestCaseNo("validateTRTForDocumentary");
	...
	public void validateProductionCompanyForDocumentary() throws Exception {
		int testCaseNo = readTestCaseNo("validateProductionCompanyForDocumentary");
